...
print_summary() {
    ...
    echo ""
    echo "  [Сервер]"
    echo "  Private key: ${SERVER_PRIVKEY}"
    echo "  Public key : ${SERVER_PUBKEY}"
    echo ""
    echo "  [Пир: ${PEER_DESC}]"
    echo "  IP пира    : ${PEER_IP}"
    echo "  Private key: ${PEER_PRIVKEY}"
    ...
    echo "  H1=${AWG_H1}  H2=${AWG_H2}"
    echo "  H3=${AWG_H3}  H4=${AWG_H4}"
    echo "============================================================"
    echo ""
    echo "  ВАЖНО: Сохрани ключи пира — они нужны для настройки клиента!"
    echo ""
    echo "============================================================"
